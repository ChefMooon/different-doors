...
import com.chefmooon.differentdoors.data.builder.fabric.WaxedCopperDoubleDoorShapelessRecipeBuilder;
...
public class RecipeGenerator extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput recipeOutput) {
        ...
        for (DoorMaterialType doorMaterialType : DoorMaterialType.values()) {
            if (doorMaterialType == DoorMaterialType.IRON || doorMaterialType == DoorMaterialType.COPPER) continue; // Skip metal doors for now
