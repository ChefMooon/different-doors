    ...
    private static void largeDoorModel(Supplier<Block> block) {
        ...
        GENERATOR.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block.get(),
                        ...
                        .with(PropertyDispatch.properties(LargeDoorBlock.SWING, LargeDoorBlock.OPEN, LargeDoorBlock.PART)
                                ...
                                .select(Boolean.FALSE, Boolean.TRUE, DoorPartProperty.LEFT, Variant.variant().with(VariantProperties.MODEL, LEFT_OPEN))
                                .select(Boolean.FALSE, Boolean.TRUE, DoorPartProperty.CENTER, Variant.variant().with(VariantProperties.MODEL, BOTTOM_OPEN))
                                .select(Boolean.FALSE, Boolean.TRUE, DoorPartProperty.RIGHT, Variant.variant().with(VariantProperties.MODEL, RIGHT_OPEN))
                                .select(Boolean.FALSE, Boolean.TRUE, DoorPartProperty.BOTTOM_LEFT, Variant.variant().with(VariantProperties.MODEL, BOTTOM_LEFT_OPEN))
                                ...
                                .select(Boolean.FALSE, Boolean.FALSE, DoorPartProperty.LEFT, Variant.variant().with(VariantProperties.MODEL, LEFT))
                                .select(Boolean.FALSE, Boolean.FALSE, DoorPartProperty.CENTER, Variant.variant().with(VariantProperties.MODEL, CENTER))
                                .select(Boolean.FALSE, Boolean.FALSE, DoorPartProperty.RIGHT, Variant.variant().with(VariantProperties.MODEL, RIGHT))
                                ...
                                .select(Boolean.TRUE, Boolean.TRUE, DoorPartProperty.TOP_RIGHT, Variant.variant().with(VariantProperties.MODEL, TOP_RIGHT_SWING_OPEN))
                                .select(Boolean.TRUE, Boolean.TRUE, DoorPartProperty.LEFT, Variant.variant().with(VariantProperties.MODEL, LEFT_SWING_OPEN))
                                .select(Boolean.TRUE, Boolean.TRUE, DoorPartProperty.CENTER, Variant.variant().with(VariantProperties.MODEL, BOTTOM_SWING_OPEN))
                                .select(Boolean.TRUE, Boolean.TRUE, DoorPartProperty.RIGHT, Variant.variant().with(VariantProperties.MODEL, RIGHT_SWING_OPEN))
                                .select(Boolean.TRUE, Boolean.TRUE, DoorPartProperty.BOTTOM_LEFT, Variant.variant().with(VariantProperties.MODEL, BOTTOM_LEFT_SWING_OPEN))
                                ...
                                .select(Boolean.TRUE, Boolean.FALSE, DoorPartProperty.LEFT, Variant.variant().with(VariantProperties.MODEL, LEFT_SWING))
                                .select(Boolean.TRUE, Boolean.FALSE, DoorPartProperty.CENTER, Variant.variant().with(VariantProperties.MODEL, CENTER_SWING))
                                .select(Boolean.TRUE, Boolean.FALSE, DoorPartProperty.RIGHT, Variant.variant().with(VariantProperties.MODEL, RIGHT_SWING))
