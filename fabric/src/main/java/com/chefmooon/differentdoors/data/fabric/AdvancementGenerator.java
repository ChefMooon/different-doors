    ...
    public void generateAdvancement(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer) {
        AdvancementHolder root = Advancement.Builder.advancement()
                .display(new DisplayInfo(
                        ...
                        Optional.of(ResourceLocation.withDefaultNamespace("textures/block/stripped_oak_log.png")),
        ...
        AdvancementHolder changeStyle = getAdvancement(root, Items.GOLDEN_PICKAXE, "change_style", AdvancementType.TASK, true, false, false)
        ...
        AdvancementHolder windChargeDoubleDoor = getAdvancement(root, Items.WIND_CHARGE, "wind_charge_double_door", AdvancementType.TASK, true, true, true)
        ...
        // Copper Doors
        AdvancementHolder copperDoors = getAdvancement(root, ModItemsImpl.WEATHERED_COPPER_DOUBLE_DOOR.get(), "copper_doors", AdvancementType.TASK, true, false, false)
        ...
        // Wax On Copper Doors
        AdvancementHolder copperDoubleDoorWaxOn = getAdvancement(copperDoors, Items.HONEYCOMB, "copper_double_door_wax_on", AdvancementType.TASK, true, false, false)
        ...
        AdvancementHolder copperDoubleDoorWaxOff = getAdvancement(copperDoubleDoorWaxOn, Items.GOLDEN_AXE, "copper_double_door_wax_off", AdvancementType.TASK, true, false, false)
