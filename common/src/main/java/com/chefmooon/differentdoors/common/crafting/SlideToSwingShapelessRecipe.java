...
//                return Boolean.FALSE.equals(doorItem.get(DataComponents.BLOCK_STATE).get(LargeDoorBlock.SWING));
            }
//            return false;
    ...
    public static class Serializer implements RecipeSerializer<SlideToSwingShapelessRecipe> {
        ...
        private static SlideToSwingShapelessRecipe fromNetwork(RegistryFriendlyByteBuf buffer) {
        ...
        private static void toNetwork(RegistryFriendlyByteBuf buffer, SlideToSwingShapelessRecipe recipe) {
