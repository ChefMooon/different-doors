...
public enum DoorMaterialType implements StringRepresentable {
    ...
    CHERRY(MapColor.TERRACOTTA_WHITE, 3.0F, 3.0F, SoundEvents.CHERRY_WOOD_DOOR_OPEN, SoundEvents.CHERRY_WOOD_DOOR_CLOSE, SoundEvents.CHERRY_WOOD_HIT, SoundEvents.CHERRY_WOOD_HIT, SoundType.CHERRY_WOOD, NoteBlockInstrument.BASS, Items.CHERRY_DOOR, Items.CHERRY_PLANKS, CreativeModeTabs.BUILDING_BLOCKS),
    BAMBOO(MapColor.COLOR_YELLOW, 3.0F, 3.0F, SoundEvents.BAMBOO_WOOD_DOOR_OPEN, SoundEvents.BAMBOO_WOOD_DOOR_CLOSE, SoundEvents.BAMBOO_WOOD_HIT, SoundEvents.BAMBOO_WOOD_HIT, SoundType.BAMBOO_WOOD, NoteBlockInstrument.BASS, Items.BAMBOO_DOOR, Items.BAMBOO_BLOCK, CreativeModeTabs.BUILDING_BLOCKS),
    CRIMSON(MapColor.CRIMSON_STEM, 3.0F, 3.0F, SoundEvents.NETHER_WOOD_DOOR_OPEN, SoundEvents.NETHER_WOOD_DOOR_CLOSE, SoundEvents.NETHER_WOOD_HIT, SoundEvents.NETHER_WOOD_HIT, SoundType.NETHER_WOOD, NoteBlockInstrument.BASS, Items.CRIMSON_DOOR, Items.CRIMSON_PLANKS, CreativeModeTabs.BUILDING_BLOCKS),
    WARPED(MapColor.WARPED_STEM, 3.0F, 3.0F, SoundEvents.NETHER_WOOD_DOOR_OPEN, SoundEvents.NETHER_WOOD_DOOR_CLOSE, SoundEvents.NETHER_WOOD_HIT, SoundEvents.NETHER_WOOD_HIT, SoundType.NETHER_WOOD, NoteBlockInstrument.BASS, Items.WARPED_DOOR, Items.WARPED_PLANKS, CreativeModeTabs.BUILDING_BLOCKS),
